...
export async function GET(req: NextRequest) {
  try {
    ...
    const analytics = await AnalyticsService.getLostFoundAnalytics(filters);
    ...
    const message = err instanceof Error ? err.message : "Failed to fetch lost & found analytics";
