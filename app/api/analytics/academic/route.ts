...
export async function GET(req: NextRequest) {
  try {
    ...
    const performance = await AnalyticsService.getAcademicPerformance(filters);
    ...
    const message = err instanceof Error ? err.message : "Failed to fetch academic performance analytics";
